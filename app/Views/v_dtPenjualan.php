    ...
    <div class="container">
        <div class="row">
            ...
            <div class="card-body">
                <form>
                <div class="row mb-3">
                    <label for="nama_produk" class="col-sm-4 col-form-label">Id Detail</label>
                    <div class="col-sm-8">
                ...
                <div class="row mb-3">
                    <label for="harga" class="col-sm-4 col-form-label">Id Penjualan</label>
                    <div class="col-sm-8">
                    <input type="text" class="form-control" id="id_penjualan">
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="id_pelanggan" class="col-sm-4 col-form-label">Id Produk</label>
                    <div class="col-sm-8">
                ...
                <div class="row mb-3">
                    <label for="id_pelanggan" class="col-sm-4 col-form-label">Jumlah Produk</label>
                    <div class="col-sm-8">
                        <select class="form-control" id="jumlah_produk">
                                <option value=""></option>
                        </select>
                    </div>
                </div>
